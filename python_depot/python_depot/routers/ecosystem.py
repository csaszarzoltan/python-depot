...
REST API endpoints:
    - GET /api/v1/ecosystem/detect/{name} — package manager detection
    - GET /api/v1/ecosystem/stats — ecosystem adoption statistics
    - GET /api/v1/ecosystem/migration-guide/{name} — migration guide
    - GET /api/v1/ecosystem/compatibility — compatibility matrix
"""
...
async def detect_package(
    ...
    Fetches PyPI JSON metadata and returns Tier 1 detection results.
    """
    # Validate package name (PEP 508 compliant: alphanumeric, dots, dashes, underscores)
