"""Analytics service — download stats aggregation, trend analysis, forecasts."""
...
from python_depot.pydepot.models import AnalyticsEvent
...
class AnalyticsService:
    ...
    Provides trending/forecast analysis based on internal event tracking
    and external PyPI Stats API data.
    """
    ...
    def trending_packages(self, period: str = "7d") -> dict[str, Any]:
        ...
        results = (
            ...
            .filter(
                AnalyticsEvent.event_type == "view",
                AnalyticsEvent.package_name.isnot(None),
            )
